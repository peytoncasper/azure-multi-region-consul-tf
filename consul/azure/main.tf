...
resource "azurerm_linux_virtual_machine" "consul" {
  ...
  provisioner "file" {
    source      = "certs/${var.datacenter}-server-consul-0.pem"
  ...
  provisioner "file" {
    source      = "certs/${var.datacenter}-server-consul-0-key.pem"
...
resource "azurerm_linux_virtual_machine" "consul_client_0" {
  ...
  provisioner "file" {
    source      = "certs/${var.datacenter}-client-consul-0.pem"
  ...
  provisioner "file" {
    source      = "certs/${var.datacenter}-client-consul-0-key.pem"
...
resource "azurerm_linux_virtual_machine" "consul_client_1" {
  ...
  provisioner "file" {
    source      = "certs/${var.datacenter}-client-consul-1.pem"
  ...
  provisioner "file" {
    source      = "certs/${var.datacenter}-client-consul-1-key.pem"
